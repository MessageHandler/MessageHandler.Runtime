   ...
   using Utf16StringValidator = System.Web.Util.Utf16StringValidator;
    ...
    internal class JavaScriptObjectDeserializer
    {
        ...
        internal static object BasicDeserialize(string input, int depthLimit, JavaScriptSerializer serializer)
        {
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.InvariantCulture, "Illegal Primitive", jsod._s.ToString()));
            }
            return result;
        }
        ...
        private object DeserializeInternal(int depth)
        {
            ...
            {
                throw new ArgumentException(_s.GetDebugString("Depth Limit Exceeded"));
            }
        ...
        private IList DeserializeList(int depth)
        {
            ...
            if (c != '[')
            {
                throw new ArgumentException(_s.GetDebugString("Invalid Array Start"));
            }
            ...
            while ((c = _s.GetNextNonEmptyChar()) != null && c != ']')
            {
                ...
                if (c != ',')
                {
                    throw new ArgumentException(_s.GetDebugString("Invalid Array Expect Comma"));
                }
            }
            if (expectMore)
            {
                throw new ArgumentException(_s.GetDebugString("Invalid Array Extra Comma"));
            }
            if (c != ']')
            {
                throw new ArgumentException(_s.GetDebugString("Invalid Array End"));
            }
            return list;
        }
        ...
        private IDictionary<string, object> DeserializeDictionary(int depth)
        {
            ...
            if (c != '{')
            {
                throw new ArgumentException(_s.GetDebugString("Expected Open Brace"));
            }
            ...
            while ((c = _s.GetNextNonEmptyChar()) != null)
            {
                ...
                if (c == ':')
                {
                    throw new ArgumentException(_s.GetDebugString("Invalid Member Name"));
                }
                ...
                if (c != '}')
                {
                    ...
                    if (c != ':')
                    {
                        throw new ArgumentException(_s.GetDebugString("Invalid Object"));
                    }
                }
        ...
        private object DeserializePrimitiveObject()
        {
            ...
            throw new ArgumentException(String.Format(CultureInfo.InvariantCulture, "Illegal Primitive", input));
        }
        ...
        private string DeserializeString()
        {
            ...
            throw new ArgumentException(_s.GetDebugString("Unterminated String"));
        }
        ...
        private void AppendCharToBuilder(char? c, StringBuilder sb)
        {
            ...
            {
                throw new ArgumentException(_s.GetDebugString("Bad Escape"));
            }
        }
        ...
        private char CheckQuoteChar(char? c)
        {
            ...
            else if (c != '"')
            {
                ...
                throw new ArgumentException(_s.GetDebugString("String Not Quoted"));
            }
